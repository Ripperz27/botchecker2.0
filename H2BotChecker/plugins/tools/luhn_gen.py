...
class Generator:
    ...
    def gen_cc(cc: str) -> str:
        if not Generator.valid_cc_to_gen(cc):
            raise ValueError("Card invalida")
        cc_temp = cc
    ...
    def get_info(bin: str):
        ...
        if cvv_to_gen != "rnd" and len(cvv_to_gen)  != 3  :
            raise ValueError("Cvv Invalido! , debe ingresar 3 numeros.")
